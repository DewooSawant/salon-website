-- =====================================================
-- Stylo Marketplace - PostgreSQL Schema (No PostGIS)
-- Uses lat/lng with Haversine formula for distance
-- =====================================================

CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- Haversine distance function (returns meters)
CREATE OR REPLACE FUNCTION haversine_distance(lat1 DOUBLE PRECISION, lng1 DOUBLE PRECISION, lat2 DOUBLE PRECISION, lng2 DOUBLE PRECISION)
...
CREATE INDEX IF NOT EXISTS idx_notif_salon_unread ON notifications(salon_id, is_read, created_at DESC);
...
-- =====================================================
-- =====================================================
-- STAFF PAY (commission, salary, payments)
-- =====================================================
...
-- =====================================================
INSERT INTO salons (name, slug, tagline, description, address, city, state, pincode, latitude, longitude, phone, whatsapp, type, avg_rating, total_ratings) VALUES
('Glamour Cuts', 'glamour-cuts-keshav-nagar', 'Premium Hair Salon', 'Experience the art of grooming at Glamour Cuts.', 'Shop No. 5, ABC Complex, Keshav Nagar', 'Pune', 'Maharashtra', '411036', 18.5362, 73.9272, '+91 98765 43210', '919876543210', 'men', 4.5, 120),
('Style Studio', 'style-studio-viman-nagar', 'Unisex Salon & Spa', 'Your one-stop destination for all grooming needs.', 'Shop No. 12, XYZ Mall, Viman Nagar', 'Pune', 'Maharashtra', '411014', 18.5679, 73.9143, '+91 98765 43211', '919876543211', 'unisex', 4.2, 85),
...
('Test Customer', '+919999900001', 'customer@test.com', '$placeholder$', 'Pune', 18.5400, 73.9100)
ON CONFLICT (phone) DO NOTHING;

INSERT INTO platform_admins (name, email, password, role) VALUES
('Platform Admin', 'admin@stylo.com', '$placeholder$', 'super_admin')
